 ...
 <?php
			...
			<nav id="primary-navigation" class="site-navigation primary-navigation" role="navigation">
				...
				<?php   $current_user = wp_get_current_user();
					...
					echo '<div id="login_cur_user" style="color:white; display:none;">' . $current_user->display_name.'</div>'; 
					?>
			</nav>          
...
<!---	<div> <?php $x = "Abra Cadabra";  $d = apply_filters( 'misha_filter', $x ); echo $d; ?> </div>   -->
